...
import type {VSCodeDataGrid, VSCodeDataGridCell, VSCodeDataGridRow} from './data-grid/index';
...
import type {VSCodePanels, VSCodePanelTab, VSCodePanelView} from './panels/index';
